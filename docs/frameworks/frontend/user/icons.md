...
To change the favicons you have to replace the files in _images_ directory. Don't rename them! They should have the same name and the same size as the default files.
