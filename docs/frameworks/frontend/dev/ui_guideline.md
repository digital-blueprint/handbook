...
2. Optional subtitle with class="subheadline" - Brief explanation of the activity
3. Introductory text - Overview of the activity, if necessary (optional)
4. Activity contents
...
The css variables in the `index.html` _overrides_ the internal variables without the prefix `override`.
